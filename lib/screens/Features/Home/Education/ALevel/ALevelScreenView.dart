...
import 'ALevelScreenViewModel.dart';

// ignore: must_be_immutable
class ALevelScreenView extends StatelessWidget {
  double blockHeight = SizeConfig.safeBlockVertical;
  double blockWidth = SizeConfig.safeBlockHorizontal;
  @override
  Widget build(BuildContext context) {
    return ViewModelBuilder<ALevelScreenViewModel>.reactive(
      viewModelBuilder: () => ALevelScreenViewModel(),
      onModelReady: (model) => {model.initialise()},
      builder: (_, model, child) {
        return SafeArea(
          child: Scaffold(
            body: CustomPageView(
              title: "A/L Certificate",
              callbackHead: () {
                Get.back();
              },
              callbackTail: () async {
